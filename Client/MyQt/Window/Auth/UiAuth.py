...
class Ui_AuthWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.main_label = QtWidgets.QLabel("Добро пожаловать в систему учёта посещений.")
        self.main_label.setAlignment(QtCore.Qt.AlignCenter)
        self.main_label.setObjectName("main_label")
        self.verticalLayout.addWidget(self.main_label)
        self.formLayout = QtWidgets.QFormLayout()
        self.formLayout.setObjectName("formLayout")
        self.label = QtWidgets.QLabel('Логин')
        ...
        self.label_2 = QtWidgets.QLabel('Пароль')
        ...
        self.auth_btn = QtWidgets.QPushButton('Войти')
